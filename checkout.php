				...
				<div class="card mb-3"><!--quantidade javascript-->
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="hidden" id="clothing_total_price2" name="clothing_total_price2" value="<?=$clothing_price?>">
						</div>
					</div>
...
<input type="hidden" name="clothing_name" value="<?= $clothing_name?>">	
<input type="hidden" name="clothing_id" value="<?= $clothing_id?>">
<input type="hidden" name="clothing_size" value="<?= $clothing_size?>">
<input type="hidden" name="clothing_color" value="<?= $clothing_color?>">
<!--/valores ocultos dos detalhes da compra para serem enviados a pagina checkout -->	
							</fieldset>	
						</div>
					</div>
